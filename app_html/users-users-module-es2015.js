...
let UsersPage = class UsersPage {
    constructor(modalController, http, loadingCtrl, alertCtrl, menuService, translate) {
    ...
    refreshData(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.http.get(`/api/crest/users`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(() => loading.dismiss()))
                .subscribe((res) => {
                if (!!res) {
                    this.users = res;
                    this.filter();
