...
let UpdatePage = class UpdatePage {
    constructor(authService, menuService, http, loadingCtrl, alertCtrl) {
    ...
    checkForUpdates() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            // STANDARD
            this.http.get('/api/status').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(() => loading.dismiss()))
                .subscribe((res) => {
    ...
    restartServer() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield loading.present();
            // STANDARD
            this.http.post('/api/server/restart', null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(() => loading.dismiss()))
                .subscribe((res) => {
            });
        });
    }
